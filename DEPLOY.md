...
5. Still under Advanced, add these environment variables:
   ...
   | `ADMIN_PASSWORD` | `Migration@20!26` |
...
Open it, sign in with the two credentials above, and **change the password
immediately** from My profile → Change password. Once you have, you can delete
the `ADMIN_PASSWORD` variable from Render; it is only used to create the very
first account.
