...
13. [Accounts, invoices and receipts](#13-accounts-invoices-and-receipts)
14. [Client case tracking](#14-client-case-tracking)
15. [Consultation reminders by email](#15-consultation-reminders-by-email)
16. [Data entry](#16-data-entry)
17. [Security](#17-security)
18. [When something goes wrong](#18-when-something-goes-wrong)
19. [The files in this repository](#19-the-files-in-this-repository)
...
## 13. Accounts, invoices and receipts
...
**US dollars is the base.** Every document is kept in the currency it was
...
same file. What comes back is deliberately thin: the case reference, the stage,
...
## 15. Consultation reminders by email
...
sent and again on the server, on both client records and staff accounts.
...
## 19. The files in this repository
